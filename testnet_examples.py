...
account = Account(indexer_client=get_v2_indexer_client(is_tesnet=True), algod_client=get_v2_algod_client(is_tesnet=True))
asset = Asset(indexer_client=get_v2_indexer_client(is_tesnet=True), algod_client=get_v2_algod_client(is_tesnet=True))
